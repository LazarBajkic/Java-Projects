...
public class Myframe extends JFrame implements ActionListener{
	...
	ImageIcon icon1=new ImageIcon("wojak.png");
	...
	Myframe(){
	    ...
	    button.setText("Stisni i dobijes kolko si lep :D ");
	    ...
	    field.setFont(new Font("MV Boli",20,15));
...
public class Myframe extends JFrame implements ActionListener{
	...
	Myframe(){
		...
		this.add(field1);
		this.add(field2);
>>>>>>> fc472e43e2e5ff9ffd6bd0d67e444e872d83d899
	}
...
<<<<<<< HEAD
		if(e.getSource()==button) {
			if (x<=5) {
				field.setText("tvoj broj je bio: "+x+ ",Ruzan si bakii");
			}
			else if(x>5) {
				field.setText("tvoj broj je bio: "+x+ ", Moze da prodje,al nikad ko ja lep bit neces B)");
			}
		}
